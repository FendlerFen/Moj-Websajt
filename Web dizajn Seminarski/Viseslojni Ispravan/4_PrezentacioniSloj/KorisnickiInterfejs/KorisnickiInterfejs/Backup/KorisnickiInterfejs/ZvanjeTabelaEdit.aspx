...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="style1">
            &nbsp;</td>
        <td>
            <asp:GridView ID="SpisakZvanjaEditGridView" runat="server" Font-Underline="False" 
                Height="277px" onselectedindexchanged="SpisakZvanjaEditGridView_SelectedIndexChanged" 
